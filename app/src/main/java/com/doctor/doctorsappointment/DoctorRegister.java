...
public class DoctorRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addKeyListenerToTextInputLayout(AddressTB);
        addKeyListenerToTextInputLayout(cityTB);
        ...
        goToLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DoctorRegister.this, LoginActivity.class).putExtra("ForDoctor",true));
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isValid()){
                    String address=AddressTB.getEditText().getText().toString().trim();
                    String city=cityTB.getEditText().getText().toString().trim();
    ...
    public void onBackPressed() {
        startActivity(new Intent(DoctorRegister.this,Select_regestrationActivity.class));
